...
- Replicate API with CLoudFlare
  - CLOUD API that runs its model remotely
  - Simple Rest API
  - serverless usage
- Though Facefusion allows for more control, Replicate API is easeier to use on devices.
