## API to Use: FaceFusion
 - Lots of license out there such as MIT License and the OpenRail-As License
 - Both are Free to use, as roylaty free, open access and down stream use
 - Only difference for OpenRail-As License is that , it is more restrictive

### OpenRail-AS License Restrictions
